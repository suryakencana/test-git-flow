...
def includeme(config):
    ...
    # chapter one
    config.add_route('chapter_manga_one',
                     '{URI}/chapter/{slug}/{chapter}/{page}'.format(
                         URI=URI_API,
                         slug='{series_slug}',
                         chapter='{chapter_slug}',
                     page='{page}'))
    # directory
    config.add_route('directory_manga', '{URI}/directory/{query}'.format(URI=URI_API,
                                                                         query='{q}'))
    ...
    config.add_route('url_chapter', '/chapter/{seriesSlug}/{chapterSlug}/{page}')
    config.add_route('url_search', '/search/{q}')
    config.add_route('url_genre', '/genre/{q}')
    config.add_route('url_directories', '/directories/{q}')
    config.add_route('url_tags', '/tags')
